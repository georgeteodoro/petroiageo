...
def config_arg_parser():
    ...
    new_arg_parser.add_argument("--phi-of", type=str, choices=['first', 'second'], required=True, help="What phi to save: first or second")
    new_arg_parser.add_argument("--it", type=int, default=None, help="A suffix number to be used in the final intersection file name")
