...
Além disso, atualmente, deve-se manualmente modificar o arquivo `wells_data3_hdf5.py` na linha 195. Deve-se popular essa lista de tuplas com as coordenadas dos poços dentro das áreas de interesse.

# TO-DO:
Modificar o código para que as coordenadas dos poços sejam automaticamente carregadas a partir de `POROSITY_FILE` por meio das colunas `area_x` e `area_y`.