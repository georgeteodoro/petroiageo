...
def computeErrors(
    ...
    with open(realValuesFileName, "r") as realValuesFile, open(
        predictedValuesFileName, "r"
    ) as predValuesFile:
        ...
        currRealValueDict = getStructuredLineFrom(
            realValuesFile, realValuesFileSep
        )
        ...
        while line not in [None, ""]:
            ...
            currPredValueDict = getStructuredLineFromLine(
                line, predictedValuesFileSep
            )
...
def config_arg_parser():
    ...
    arg_parser.add_argument(
        "--real-file", type=str, help="The real values file path", required=True
    )
    arg_parser.add_argument(
        "--pred-file",
        type=str,
        help="The predicted values file path",
        required=True,
    )
